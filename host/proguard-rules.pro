# host is published as an AAR and is not minified on its own (isMinifyEnabled = false), so
...
# into the consumer app's R8 configuration. Keep this file empty unless host itself is ever
