...
The inbox belongs to the account, so these verbs need a grant on the **whole pod**: View to read it, Edit to delete from it, and **Full access** to send anything as the user. See [App access](https://androidsolidservices.erfangholami.com/0.8/build/app-access/index.md).
