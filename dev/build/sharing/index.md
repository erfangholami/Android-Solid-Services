...
Requests arrive through the [inbox](https://androidsolidservices.erfangholami.com/dev/build/notifications/index.md):
...
- [Activity Streams 2.0](https://www.w3.org/TR/activitystreams-core/) — the Offer/Update/Undo/Accept/Reject activities the engine sends and consumes; envelope, deviations and the impersonation gate are documented in [Notifications](https://androidsolidservices.erfangholami.com/dev/build/notifications/index.md).
